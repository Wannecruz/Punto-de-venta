    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li id="elem_ventas"><a href="./ventas"><i class="fa fa-money"></i> Ventas</a></li>
                ...
                <li id="elem_reportes" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="./productos-en-stock">Productos en Bodega</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li id="elem_ajustes" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="./ajustes"><i class="fa fa-cogs"></i> Generalidades</a></li>
